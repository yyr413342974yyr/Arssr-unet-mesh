...
if __name__ == '__main__':
    ...
    到文件夹这一步就行
    '''
    parser.add_argument('--input_path', type=str, default="/data0/yurunyang/Input/", dest='input_path',
    ...
    parser.add_argument('--output_path', type=str, default="/data0/yurunyang/", dest='output_path',
    ...
    for f in filenames: #tqdm(filenames)
        ...
        utils.write_img(vol=img_pre,
                        ...
                        ref_path=ref_path,
                        out_path=os.path.join(dir_path, f'epoch_{epoch_s}_pred_{f}'),
